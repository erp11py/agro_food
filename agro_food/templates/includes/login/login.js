...
login.bind_events = function() {
	...
	$(".form-signup").on("submit", function(event) {
		...
		// added more fields
		args.aadhar_card=($("#signup_aadhar_card").val() || "").trim();
		args.mobile_number1=($("#signup_mobile_number").val() || "").trim();
        args.mobile_number= args.mobile_number1.replace(/[^\d]/g, '');
        args.location=($("#signup_location").val() || "").trim();
